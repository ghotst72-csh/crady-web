...
export function HeroSearch({
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-gradient-to-b from-blue-50 to-white border border-blue-100/60 px-6 sm:px-10 py-12 sm:py-16 text-center">
      {/* Purely decorative ascending trend line, matching the approved
          hero design — no data behind it, hidden from assistive tech and
          clipped from narrow viewports where it would collide with text. */}
      <svg
        aria-hidden="true"
        className="hidden lg:block absolute top-8 right-8 opacity-70"
        width="160"
        height="70"
        viewBox="0 0 160 70"
        fill="none"
